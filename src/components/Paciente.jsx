  ...
  return (
     <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      ...
      <div className="flex justify-between my-8">
        <button
          type="button"
          className="py-2 px-10 bg-indigo-700 hover:bg-indigo-800 text-yellow-50 font-bold uppercase rounded-lg"
        ...
        <button
          type="button"
          className="py-2 px-10 bg-red-700 hover:bg-red-800 text-yellow-50 font-bold uppercase rounded-lg"
